...
class CountDownClock : LinearLayout {
    ...
    fun resetCountdownTimer() {
        countDownTimer?.cancel()
        firstDigitMonths.setNewText(resetSymbol)
        secondDigitMonths.setNewText(resetSymbol)
    ...
    private fun setCountDownTime(timeToStart: Long) {
        ...
        val months = TimeUnit.MILLISECONDS.toDays(timeToStart) / 30
        ...
        val monthsString = months.toString()
        val daysString = (days - (months * 30)).toString()
        val hoursString = hours.toString()
        val minutesString = minutes.toString()
        val secondsString = seconds.toString()

        when {
            monthsString.length == 2 -> {
                firstDigitMonths.animateTextChange((monthsString[0].toString()))
                secondDigitMonths.animateTextChange((monthsString[1].toString()))
            }
            monthsString.length == 1 -> {
                firstDigitMonths.animateTextChange(("0"))
                secondDigitMonths.animateTextChange((monthsString[0].toString()))
            }
            else -> {
                firstDigitMonths.animateTextChange(("1"))
                secondDigitMonths.animateTextChange(("2"))
            }
        }
    ...
    private fun setDigitTopDrawable(digitTopDrawable: Drawable?) {
        if (digitTopDrawable != null) {
            firstDigitMonths.frontUpper.background = digitTopDrawable
            firstDigitMonths.backUpper.background = digitTopDrawable
            secondDigitMonths.frontUpper.background = digitTopDrawable
            secondDigitMonths.backUpper.background = digitTopDrawable
    ...
    private fun setDigitBottomDrawable(digitBottomDrawable: Drawable?) {
        if (digitBottomDrawable != null) {
            firstDigitMonths.frontLower.background = digitBottomDrawable
            firstDigitMonths.backLower.background = digitBottomDrawable
            secondDigitMonths.frontLower.background = digitBottomDrawable
            secondDigitMonths.backLower.background = digitBottomDrawable
    ...
    private fun setDigitDividerColor(digitDividerColor: Int) {
        ...
        firstDigitMonths.digitDivider.setBackgroundColor(dividerColor)
        secondDigitMonths.digitDivider.setBackgroundColor(dividerColor)
    ...
    private fun setDigitPadding(digitPadding: Int) {
        ...
        firstDigitMonths.setPadding(digitPadding, digitPadding, digitPadding, digitPadding)
        secondDigitMonths.setPadding(digitPadding, digitPadding, digitPadding , digitPadding)
    ...
    private fun setDigitTextColor(digitsTextColor: Int) {
        ...
        firstDigitMonths.frontUpperText.setTextColor(textColor)
        firstDigitMonths.backUpperText.setTextColor(textColor)
        ...
        secondDigitMonths.frontUpperText.setTextColor(textColor)
        secondDigitMonths.backUpperText.setTextColor(textColor)
        ...
        firstDigitMonths.frontLowerText.setTextColor(textColor)
        firstDigitMonths.backLowerText.setTextColor(textColor)
        ...
        secondDigitMonths.frontLowerText.setTextColor(textColor)
        secondDigitMonths.backLowerText.setTextColor(textColor)
    ...
    private fun setDigitTextSize(digitsTextSize: Float) {
        ...
        firstDigitMonths.frontUpperText.setTextSize(TypedValue.COMPLEX_UNIT_PX, digitsTextSize)
        firstDigitMonths.backUpperText.setTextSize(TypedValue.COMPLEX_UNIT_PX, digitsTextSize)
        secondDigitMonths.frontUpperText.setTextSize(TypedValue.COMPLEX_UNIT_PX, digitsTextSize)
        secondDigitMonths.backUpperText.setTextSize(TypedValue.COMPLEX_UNIT_PX, digitsTextSize)
        ...
        firstDigitMonths.frontLowerText.setTextSize(TypedValue.COMPLEX_UNIT_PX, digitsTextSize)
        firstDigitMonths.backLowerText.setTextSize(TypedValue.COMPLEX_UNIT_PX, digitsTextSize)
        secondDigitMonths.frontLowerText.setTextSize(TypedValue.COMPLEX_UNIT_PX, digitsTextSize)
        secondDigitMonths.backLowerText.setTextSize(TypedValue.COMPLEX_UNIT_PX, digitsTextSize)
    ...
    private fun setHalfDigitHeightAndDigitWidth(halfDigitHeight: Int, digitWidth: Int) {
        ...
        setHeightAndWidthToView(firstDigitMonths.frontUpper, halfDigitHeight, digitWidth)
        setHeightAndWidthToView(firstDigitMonths.backUpper, halfDigitHeight, digitWidth)
        setHeightAndWidthToView(secondDigitMonths.frontUpper, halfDigitHeight, digitWidth)
        setHeightAndWidthToView(secondDigitMonths.backUpper, halfDigitHeight, digitWidth)
        ...
        // Lower
        setHeightAndWidthToView(firstDigitMonths.frontLower, halfDigitHeight, digitWidth)
        setHeightAndWidthToView(firstDigitMonths.backLower, halfDigitHeight, digitWidth)
        setHeightAndWidthToView(secondDigitMonths.frontLower, halfDigitHeight, digitWidth)
        setHeightAndWidthToView(secondDigitMonths.backLower, halfDigitHeight, digitWidth)
        ...
        // Dividers
        firstDigitMonths.digitDivider.layoutParams.width = digitWidth
        secondDigitMonths.digitDivider.layoutParams.width = digitWidth
    ...
    private fun setAnimationDuration(animationDuration: Int) {
        firstDigitMonths.setAnimationDuration(animationDuration.toLong())
        secondDigitMonths.setAnimationDuration(animationDuration.toLong())
    ...
    private fun setTransparentBackgroundColor() {
        ...
        firstDigitMonths.frontLower.setBackgroundColor(transparent)
        firstDigitMonths.backLower.setBackgroundColor(transparent)
        secondDigitMonths.frontLower.setBackgroundColor(transparent)
        secondDigitMonths.backLower.setBackgroundColor(transparent)
    ...
    fun pauseCountDownTimer() {
     ...
     fun resumeCountDownTimer(m: Long) {
//         val ll = System.currentTimeMillis() - m
//         Log.e("saff", ll.toString())
         milliLeft = m
         startCountDown(milliLeft)
    }

    fun setCustomTypeface(typeface : Typeface){
        firstDigitMonths.setTypeFace(typeface)
        firstDigitMonths.setTypeFace(typeface)
        secondDigitMonths.setTypeFace(typeface)
        secondDigitMonths.setTypeFace(typeface)
