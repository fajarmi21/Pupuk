...
import kotlinx.android.synthetic.main.fragment_kp_detail_rekap.*

class KpDetailRekapFragment : Fragment() {

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
                              savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_kp_detail_rekap, container, false)
    }
